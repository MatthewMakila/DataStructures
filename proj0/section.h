 ...
 *  section.h
 *  2/9/22
 *  This header file includes all the documentation for the random and section class. There are all section methods
 *  defined here
 */
#ifndef SECTION_H
#define SECTION_H
...
class Section{
    ...
    ~Section();
    void clear();
    void insert();//inserts random real numbers as grades
    void dump();//for debugging purposes
    double studentAverage(int student);
    double quizAverage(int quiz);
    double classAverage();
